...
namespace arasy::core {
    namespace internal {
        ...
        public:
            ...
            virtual void changeOwnershipTo(lua_State* to) { (void) to; }
        };
    }
    ...
    template<typename T>
    constexpr inline bool is_lua_wrapper_type_v = std::is_base_of_v<internal::LuaBaseType, T>;
    ...
    constexpr inline bool all_are_convertible_to_lua_value_v = (std::is_convertible_v<Ts, arasy::core::LuaValue> && ...);

    template<typename... Ts>
    constexpr inline bool all_are_lua_types_v = (is_lua_wrapper_type_v<Ts> && ...);

...
LuaValue& LuaValue::operator=(const LuaValue& other) {
    return *new (this) LuaValue(other);
}
...
std::ostream& arasy::core::operator<<(std::ostream& os, const LuaValueType& value) {
...
std::ostream& arasy::core::operator<<(std::ostream& os, const LuaValue& lv) {
    std::visit(
        arasy::utils::internal::overload{
